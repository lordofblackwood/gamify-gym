...
See [methodology and reproducible data build](docs/strength-data.md). This calibration replaces the fixed-pound scale and can change existing power ranks without changing lift records or consistency.
